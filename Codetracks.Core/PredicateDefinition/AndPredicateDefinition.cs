...
{
    public class AndPredicateDefinition<T> : BinnaryPredicateDefinition<T>
    {
        public AndPredicateDefinition(IPredicateDefinition<T> left, IPredicateDefinition<T> right) : base(left, right)
        {
